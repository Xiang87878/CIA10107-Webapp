...
<body bgcolor='white'>
	...
	<FORM METHOD="post" ACTION="member.do" name="form1">
		<table>
			...
			<!-- 	<tr> -->
			<!-- 		<td>會員性別:</td> -->
			<%-- 		<td><input type="TEXT" name="memberGender"   value="${param.memberGender}"   size="45"/></td> <td>${errorMsgs.memberGender}</td> --%>
			<!-- 	</tr> -->
			<tr>
				<td>性別:</td>
		...
		<br> <input type="hidden" name="action" value="update"> <input
			type="hidden" name="memberId" value="${param.memberId}"> <input
